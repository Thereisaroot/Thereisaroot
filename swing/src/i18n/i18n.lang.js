(function (global) {
  ...
  translations.en = {
    ...
    debug: {
      ...
      submitLeaderboard: 'Submit Leaderboard Score',
      submitLeaderboardButton: 'Submit 10',
      setBest: 'Set Best Score',
      setBestButton: 'Best = 10',
    ...
    settings: {
      ...
      helpLocked: 'Select language',
      helpUnlocked: 'Select language',
    ...
    code: {
      ...
      submit: 'Redeem',
      cancel: 'Cancel',
      invalidFormat: 'Use 1-8 letters or numbers.',
      alreadyUsed: 'This code has already been redeemed.',
      unknown: 'Unknown code.',
      success: 'Code redeemed! +${amount}',
    },
    languages: {
      en: { name: 'English' },
      ko: { name: '한국어' },
    ...
    ads: {
      ...
      lifeTapToWatch: '',
      lifeErrorFallback: 'Ad error, +{lives} lives granted.',
      lifeWatchButton: 'Watch ad to refill lives',
      lifeRechargeSuccess: '+{lives} lives added',
      lifeRechargeError: 'Ad failed, +{lives} lives',
    },
    adsShop: {
      title: 'AD SHOP',
      ...
      startSkillOwned: 'Start Skill already unlocked.',
      infiniteGambleTitle: 'Infinite Gamble Unlock',
      infiniteGambleDesc: 'Watch 20 ads to unlock the permanent 1.3x Gamble bonus.',
      infiniteGambleUnlocked: 'Infinite Gamble unlocked!',
      infiniteGambleOwned: 'Infinite Gamble already unlocked.',
      requireRewardViews: 'Watch {required} ads to unlock (now: {current}).',
      watch: 'WATCH AD',
      loading: 'Loading...',
    ...
    items: {
      ...
      gamble: {
        name: 'Gamble',
        description: 'Next run earns 1.3x money and EXP.',
      },
      gamble_infinite: {
        name: 'Infinite Gamble',
        description: 'Every run starts with the Gamble bonus (1.3x money & EXP).',
      },
      magnet: {
        name: 'Magnet',
  ...
  translations.ko = {
    ...
    debug: {
      ...
      submitLeaderboard: '리더보드 점수 제출',
      submitLeaderboardButton: '점수 10 제출',
      setBest: '베스트 점수 설정',
      setBestButton: '베스트 10으로 설정',
      livesReset: '기회 리셋',
      livesAdd: '기회 +10',
    ...
    settings: {
      title: '설정',
      currentMarker: '(현재)',
      helpLocked: '언어를 선택하세요',
      helpUnlocked: '언어를 선택하세요',
      codeButton: '코드 입력',
    },
    code: {
      title: '코드 입력',
      inputLabel: '8자리 코드를 입력하세요',
      placeholder: 'ABCDEFGH',
      submit: '적용',
      cancel: '취소',
      invalidFormat: '영문/숫자 1~8자리만 사용할 수 있습니다.',
      alreadyUsed: '이미 사용한 코드입니다.',
      unknown: '등록되지 않은 코드입니다.',
      success: '코드가 적용되었습니다! +${amount}',
    },
    languages: {
      en: { name: 'English' },
      ko: { name: '한국어' },
    ...
    ads: {
      ...
      lifeTapToWatch: '',
      lifeErrorFallback: '광고 오류, +{lives} 충전',
      lifeWatchButton: '광고 보고 기회 충전',
      lifeRechargeSuccess: '충전 +{lives}',
      lifeRechargeError: '광고 실패, 충전 +{lives}',
    },
    adsShop: {
      title: '광고 상점',
      tossTitle: '토스 광고 상점',
      ...
      startSkillOwned: '이미 스타트 스킬을 배웠습니다.',
      infiniteGambleTitle: '무한 갬블 해금',
      infiniteGambleDesc: '광고 20회를 시청하면 갬블 1.3배 효과가 영구 적용됩니다.',
      infiniteGambleUnlocked: '무한 갬블을 획득했습니다!',
      infiniteGambleOwned: '무한 갬블을 이미 보유 중입니다.',
      requireRewardViews: '총 광고 {required}회 시청 필요 (현재 {current}회)',
      watch: '광고 보기',
      loading: '불러오는 중...',
      claimedToday: '시간이 더 필요합니다.',
    ...
    items: {
      ...
      gamble: {
        name: '갬블',
        description: '다음 런의 돈과 경험치가 1.3배가 되고 한 번 사용 후 사라집니다.',
      },
      gamble_infinite: {
        name: '무한 갬블',
        description: '구매 후 모든 런에서 자동으로 갬블 효과(돈/경험치 1.3배)가 적용됩니다.',
      },
      magnet: {
        name: '마그넷',
