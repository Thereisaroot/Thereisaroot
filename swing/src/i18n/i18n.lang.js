(function (global) {
  ...
  const en = {
    ...
    ads: {
      lifeCounter: '목숨 {current}/{max}',
      lifeLoading: '광고 불러오는 중... 잠시만요!',
      lifeRewarded: '목숨 +{lives}! 다시 도전해요!',
      lifePartial: '부분 보상: 목숨 +{lives} 획득.',
      lifeLimit: '오늘 광고 한도({limit}회)를 모두 사용했습니다.',
      lifeError: '광고 재생에 실패했어요. 잠시 후 다시 시도해주세요.',
      lifeUnavailable: '현재 광고를 사용할 수 없습니다.',
      lifePrompt: '목숨이 없습니다! 광고를 보면 충전돼요.',
      lifeTapToWatch: '화면을 터치하면 광고를 보고 목숨을 얻습니다.',
    },
    adsShop: {
      title: '광고 상점',
      wizardTitle: '위자드 해제',
    ...
    ads: {
      ...
      lifePrompt: 'No lives left! Watch an ad to recharge.',
      lifeTapToWatch: 'Tap to watch an ad and gain lives.',
    },
    adsShop: {
      title: 'AD SHOP',
