...
// ESM-style exports (optional if using <script type="module">)
export const saveInit = (ns) => SafeStorage.init({ namespace: ns });
export const saveSet = (key, value) => SafeStorage.set(key, value);
export const saveGet = (key, fallback) => SafeStorage.get(key, fallback);
export const saveRemove = (key) => SafeStorage.remove(key);
export const saveExport = () => SafeStorage.exportAll();
export const saveImport = (data, overwrite = true) => SafeStorage.importAll(data, overwrite);
